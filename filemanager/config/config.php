...
function getBaseUrl() 
{
	...
	$index = strpos($pathInfo['dirname'], '/filemanager');
	if($index <= 0)
		$pathInfo['dirname'] = '';
	else
		$pathInfo['dirname'] = substr($pathInfo['dirname'], 0, $index);
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/public/upload/images/',
	...
	|
	*/
	'current_path' => '../public/upload/images/',
	...
	|
	*/
	'thumbs_base_path' => '../public/upload/images/thumbs/',
